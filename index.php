                    ...
                    <div class="list__dois">
                        ...
                        <div class="list__trigger">
                            ...
                            <div class="conteudo__dois">
                                <a class="btn" id="rem_inter_inf" href="#abrirModal_i1"><span>REMANEJAMENT INTERNO</span></a>
                                ...
                                <a class="btn" id="rem_rede_inf" ref="#abrirModal_i2"><span>REMANEJAMENTO EM REDE</span></a>
                                    ...
                                    <div class="box">
                                        <form action="" method="post" id="frm_i2" class="frm">
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="inputBox">
                                                    <label for="listInf_i2s1" class="labelInput">Instituição de Ensino Atual</label><br>
                                                    <select id="listInf_i2s1" name="listRemIntInf" required>
                                                        <option class="listInf__opt" value="selecionar">Selecione a Instituição Atual</option>
                                                ...
                                                <div class="inputBox">
                                                    ...
                                                    <div class="inputBox__radio">
                                                        ...
                                                        <label class="inputBox__radio" for="matutino">Matutino</label><br>
                                                        ...
                                                        <label class="inputBox__radio" for="semturno">Sem preferência de turno</label>
                                                    </div>
                                                </div>
                                                <br>

                                                <div class="inputBox">
                                                    <label for="listInf_i2s2" class="labelInput">Turma pretendida</label><br>
                                                ...
                                                <div class="inputBox">
                                                    <input type="text" name="nome" id="nome_i2" class=inputUser required>
                                                ...
                                                <div class="inputBox">
                                                    ...
                                                    <input type="date" name="data_nascimento" id="data_nascimento_i2" required>
                                                </div>
                                                <br>

                                                <div class="inputBox">
                                                    <input type="text" name="naturalidade" id="natural_i2" class=inputUser
                                                        required>
                                ...
                                <a class="btn" id="cad_res_inf" href="#abrirModal_i3"><span>CADASTRO DE RESERVA</span></a>
                                <!--CADASTRO DE RESERVA-->
