                        ...
                        <div class="list__trigger">
                            ...
                            <div class="conteudo__dois">
                                ...
                                <a class="btn" id="rem_rede_inf" href="#abrirModal_i2"><span>REMANEJAMENTO EM
                                        REDE</span></a>
                                <!--REMANEJAMENTO EM REDE-->
                                <div id="abrirModal_i2" class="modal">
                                    <div class="box">
                                        <form action="" method="post" id="frm_i2" class="frm">
                                            <a href="#fechar_i2" title="Fechar" id="fechar_i2" class="fechar">x</a>
                                            <fieldset>
                                                <legend>REMANEJAMENTO EM REDE</legend>
                                                <br><br>

                                                <div class="inputBox">
                                                    <label for="listInf_i2s1" class="labelInput">Instituição de Ensino
                                                        Atual</label><br>
                                                    <select id="listInf_i2s1" name="listRemIntInf" required>
                                                        <option class="listInf__opt" value="selecionar">Selecione a
                                                            Instituição Atual</option>
                                                ...
                                                <div class="inputBox">
                                                    ...
                                                    <div class="inputBox__radio">
                                                        <input type="radio" name="turno" id="matutino_i2"
                                                            value="matutino" required>
                                                        <label class="inputBox__radio"
                                                            for="matutino_i2">Matutino</label><br>
                                                        <input type="radio" name="turno" id="vespertino_i2"
                                                            value="vespertino" required>
                                                        <label class="inputBox__radio"
                                                            for="vespertino_i2">Vespertino</label><br>
                                                        <input type="radio" name="turno" id="semturno_i2"
                                                            value="semPreferenciaTurno" required>
                                                        <label class="inputBox__radio" for="semturno_i2">Sem preferência
                                                            de turno</label>
                                                    </div>
                                                </div>
                                                <br>
                                                ...
                                                <div class="inputBox">
                                                    <label for="listInf_i2s2" class="labelInput">Turma
                                                        pretendida</label><br>
                                                    <select id="listInf_i2s2" name="listRemIntInf" required>
                                                ...
                                                <div class="inputBox">
                                                    <input type="text" name="nome" id="nome_i2" class=inputUser
                                                        required>
                                                    <label for="nome_i2" class="labelInput">Nome completo do
                                                        estudante</label>
                                                </div>
                                                <br>

                                                <div class="inputBox">
                                                    <label for="data_nascimento_i2">Data de Nascimento:</label>
                                                    <input type="date" name="data_nascimento" id="data_nascimento_i2"
                                                        required>
                                                </div>
                                                <br>

                                                <div class="inputBox">
                                                    <input type="text" name="naturalidade" id="natural_i2"
                                                        class=inputUser required>
                                                    <label for="natural_i2" class="labelInput">Naturalidade</label>
                                                </div>
                                                <br>
                                                ...
                                                <div class="inputBox">
                                                    <p>Gênero:</p>
                                                    <div class="inputBox__radio">
                                                        <input type="radio" name="genero" id="masculino_i2"
                                                            value="masculino" required>
                                                        <label class="inputBox__radio"
                                                            for="masculino_i2">Masculino</label><br>
                                                        <input type="radio" name="genero" id="feminino_i2"
                                                            value="feminino" required>
                                                        <label class="inputBox__radio"
                                                            for="feminino_i2">Feminino</label>
                                                    </div>
                                                </div>
                                                <br>
                                                ...
                                                <div class="inputBox">
                                                    <p>Cor/Raça:</p>
                                                    <div class="inputBox__radio">
                                                        <input type="radio" name="cor" id="cor__branca_i2"
                                                            value="branca" required>
                                                        <label class="inputBox__radio"
                                                            for="cor__branca_i2">Branca</label><br>
                                                        <input type="radio" name="cor" id="cor__parda_i2" value="parda"
                                                            required>
                                                        <label class="inputBox__radio"
                                                            for="cor__parda_i2">Parda</label><br>
                                                        <input type="radio" name="cor" id="cor__indigena_i2"
                                                            value="indigena" required>
                                                        <label class="inputBox__radio"
                                                            for="cor__indigena_i2">Índigena</label><br>
                                                        <input type="radio" name="cor" id="cor__preta_i2" value="preta"
                                                            required>
                                                        <label class="inputBox__radio"
                                                            for="cor__preta_i2">Preta</label><br>
                                                        <input type="radio" name="cor" id="cor__amarela_i2"
                                                            value="amarela" required>
                                                        <label class="inputBox__radio"
                                                            for="cor__amarela_i2">Amarela</label><br>
                                                        <input type="radio" name="cor" id="cor__ndeclarada_i2"
                                                            value="naoDeclarada" required>
                                                        <label class="inputBox__radio" for="cor__ndeclarada_i2">Não
                                                            declarada</label>
                                                    </div>
                                                </div>
                                                <br>
                                                ...
                                                <div class="inputBox">
                                                    <p>É aluno público alvo da Educação Especial?</p>
                                                    <div class="inputBox__radio">
                                                        <input type="radio" name="especial" id="ee__sim_i2" value="sim"
                                                            required>
                                                        <label class="inputBox__radio" for="ee__sim_i2">Sim</label>
                                                        <input type="radio" name="especial" id="ee__nao_i2" value="nao"
                                                            required>
                                                        <label class="inputBox__radio" for="ee__nao_i2">Não</label>
                                                    </div>
                                                </div>
                                                <br>
                                                ...
                                                <div class="inputBox">
                                                    <p>Frequenta sala de recurso (AEE)?</p>
                                                    <div class="inputBox__radio">
                                                        <input type="radio" name="especial" id="aee__sim_i2" value="sim"
                                                            required>
                                                        <label class="inputBox__radio" for="aee__sim_i2">Sim</label>
                                                        <input type="radio" name="especial" id="aee__nao_i2" value="nao"
                                                            required>
                                                        <label class="inputBox__radio" for="aee__nao_i2">Não</label>
                                                    </div>
                                                </div>
                                                <br>
                                                ...
                                                <div class="inputBox">
                                                    <p>Faz uso de medicamento contínuo?</p>
                                                    <div class="inputBox__radio">
                                                        <input type="radio" name="medicamento" id="me__sim_i2"
                                                            value="sim" required>
                                                        <label class="inputBox__radio" for="me__sim_i2">Sim</label>
                                                        <input type="radio" name="medicamento" id="me__nao_i2"
                                                            value="nao" required>
                                                        <label class="inputBox__radio" for="me__nao_i2">Não</label>
                                                    </div>
                                                </div>
                                                <br>
                                                ...
                                                <div class="inputBox">
                                                    <p>Responsável Legal:</p>
                                                    <div class="inputBox__radio">
                                                        <input type="radio" name="responsavel" id="rl__pai_i2"
                                                            value="pai" required>
                                                        <label class="inputBox__radio" for="rl__pai_i2">Pai</label><br>
                                                        <input type="radio" name="responsavel" id="rl__mae" value="mae"
                                                            required>
                                                        <label class="inputBox__radio" for="rl__mae_i2">Mãe</label><br>
                                                        <input type="radio" name="responsavel" id="rl__responsavel_i2"
                                                            value="responsavel_legal" required>
                                                        <label class="inputBox__radio"
                                                            for="rl__responsavel_i2">Responsável
                                                            Legal</label>
                                                    </div>
                                                </div>
                                                <br><br>
                                                ...
                                                <div class="inputBox">
                                                    <input type="tel" name="telefone" id="telefone_i2" class=inputUser
                                                        required>
                                                    <label for="telefone_i2" class="labelInput">Número do
                                                        telefone</label>
                                                </div>
                                                <br><br>

                                                <div class="inputBox">
                                                    <input type="text" name="email" id="email_i2" class=inputUser
                                                        required>
                                                    <label for="email_i2" class="labelInput">Email</label>
                                                </div>
                                                <br><br>

                                                <div class="inputBox">
                                                    <input type="text" name="cep" id="cep_i2" class=inputUser required>
                                                    <label for="cep_i2" class="labelInput">Cep</label>
                                                </div>
                                                <br><br>

                                                <div class="inputBox">
                                                    <input type="text" name="municipio" id="municipio_i2"
                                                        class=inputUser required>
                                                    <label for="municipio_i2" class="labelInput">Município</label>
                                                </div>
                                                <br><br>

                                                <div class="inputBox">
                                                    <input type="text" name="endereco" id="endereco_i2" class=inputUser
                                                        required>
                                                    <label for="endereco_i2" class="labelInput">Endereço</label>
                                                </div>
                                                <br><br>
                                                ...
                                                <div class="inputBox">
                                                    ...
                                                    <div class="inputBox__radio">
                                                        <input type="radio" name="localizacao"
                                                            id="localizacao__urbana_i2" value="urbana" required>
                                                        <label class="inputBox__radio"
                                                            for="localizacao__urbana_i2">Urbana</label>
                                                        <input type="radio" name="localizacao"
                                                            id="localizacao__rural_i2" value="rural" required>
                                                        <label class="inputBox__radio"
                                                            for="localizacao__rural_i2">Rural</label>
                                                    </div>
                                                </div>
                                                <br><br>
                                                ...
                                                <div class="inputBox">
                                                    <p>Necessita de transporte escolar?</p>
                                                    <div class="inputBox__radio">
                                                        <input type="radio" name="transporte" id="te__sim_i2"
                                                            value="sim" required>
                                                        <label class="inputBox__radio" for="te__sim_i2">Sim</label>
                                                        <input type="radio" name="transporte" id="te__nao_i2"
                                                            value="nao" required>
                                                        <label class="inputBox__radio" for="te__nao_i2">Não</label>
                                                    </div>
                                                </div>
                                                <br><br>

                                                <div class="inputBox">
                                                    <input type="text" name="edp" id="edp_i2" class=inputUser required>
                                                    <label for="edp_i2" class="labelInput">Número do Código da EDP
                                                        (Talão de Energia)</label>
                                                </div>
                                                <br><br>

                                                <input type="submit" class="submit" name="submit" id="submit_i2"
                                                    value="Enviar">
                                            </fieldset>
                                        </form>
                                    </div>
                                </div>
                                <!--parei aqui renomeando os IDs-->
                                    ...
                                    <div class="box">
                                        <form action="index.html" method="post" id="frm" class="frm">
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="inputBox">
                                                    <p><b>Após a confirmação da vaga, o responsável pelo aluno deverá
                                                            comparecer na Instituição com documentação, original e cópia
                                                            para efetivação da matrícula</b></p>
                                                    <br>
                                                    <p>
                                                        Ducumentos originais e uma cópia de cada documento para
